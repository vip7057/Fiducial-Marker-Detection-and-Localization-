...
def create_ellipse_with_concentric_child_image(size, center, axes, angle):
    """
    Create a binary ellipse edge image with one perfectly concentric child ellipse.

    Parameters:
    - size: Tuple, size of the image (height, width).
    - center: Tuple, coordinates of the center of the main ellipse.
    - axes: Tuple, semi-major and semi-minor axes of the main ellipse.
    - angle: Rotation angle of the main ellipse.

    Returns:
    - image: Numpy array, binary ellipse edge image.
    - child_axes_ratio: Ratio between child and parent ellipse axes.
    """
...
for i in range(501, 1001):
    ...
    noisy_image, _ = create_ellipse_with_concentric_child_image(size, center, axes, angle)
